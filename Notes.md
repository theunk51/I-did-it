...
Task List
- [ ] The parsing function table should be seperated into two dicts because most of the entries only have one parsing function. It also makes the parse_expression() function more readable.
- [ ] This entire project needs some refactoring
- [ ] update the lexer to match the grammatical constructs of Darmouth BASIC
